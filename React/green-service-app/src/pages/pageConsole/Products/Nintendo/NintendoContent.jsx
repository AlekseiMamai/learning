...
const NintendoContent = () => {
    ...
    const [listItem, setListItem] = useState(nintendoWorkList);

    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Приставки {'>'} Nintendo</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт приставок Nintendo</div>
                <img src='http://localhost:3000/productsImg/consoles/nintendo.jpg' alt=''/>
            </div>
