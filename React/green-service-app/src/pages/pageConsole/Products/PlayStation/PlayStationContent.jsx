...
const PlayStationContent = () => {

    const [listItem, setListItem] = useState(psWorkList);

    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Приставки {'>'} PlayStation</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт приставок PlayStation</div>
                <img src='http://localhost:3000/productsImg/consoles/ps.jpg' alt=''/>
            </div>
...
export default PlayStationContent;