...
const LenovoContent = () => {
    ...
    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Моноблоки {'>'} Lenovo</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт моноблоков Lenovo</div>
                <img src='http://localhost:3000/productsImg/desktops/lenovo.jpg' alt=''/>
            </div>
