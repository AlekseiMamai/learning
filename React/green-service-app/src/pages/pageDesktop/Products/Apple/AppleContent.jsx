...
const AppleContent = () => {
    ...
    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Моноблоки {'>'} Apple</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт моноблоков Apple</div>
                <img src='http://localhost:3000/productsImg/desktops/apple.jpg' alt=''/>
            </div>
