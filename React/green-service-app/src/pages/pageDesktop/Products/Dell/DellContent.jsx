...
const DellContent = () => {
    ...
    const [listItem, setListItem] = useState(dellWorkList);

    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Моноблоки {'>'} Dell</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт моноблоков Dell</div>
                <img src='http://localhost:3000/productsImg/desktops/dell.jpg' alt=''/>
            </div>
