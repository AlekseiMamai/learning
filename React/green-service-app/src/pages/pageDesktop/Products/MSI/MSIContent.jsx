...
const MSIContent = () => {
    ...
    const [listItem, setListItem] = useState(msiWorkList);

    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Моноблоки {'>'} MSI</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт моноблоков MSI</div>
                <img src='http://localhost:3000/productsImg/desktops/msi.png' alt=''/>
            </div>
