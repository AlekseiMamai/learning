...
const SamsungContent = () => {
    ...
    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Планшеты {'>'} Samsung</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт планшетов Samsung</div>
                <img src='http://localhost:3000/productsImg/tablets/samsung.jpg' alt=''/>
            </div>
