...
const LenovoContent = () => {
    ...
    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Планшеты {'>'} Lenovo</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт планшетов Lenovo</div>
                <img src='http://localhost:3000/productsImg/tablets/lenovo.png' alt=''/>
            </div>
