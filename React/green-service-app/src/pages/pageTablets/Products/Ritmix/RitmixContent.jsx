...
const RitmixContent = () => {
    ...
    const [listItem, setListItem] = useState(ritmixWorkList);

    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Планшеты {'>'} Ritmix</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт планшетов Ritmix</div>
                <img src='http://localhost:3000/productsImg/tablets/ritmix.jpg' alt=''/>
            </div>
