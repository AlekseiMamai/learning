...
const AcerContent = () => {
    ...
    const [listItem, setListItem] = useState(acerWorkList);

    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Планшеты {'>'} Acer</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт планшетов Acer</div>
                <img src='http://localhost:3000/productsImg/tablets/acer.png' alt=''/>
            </div>
