...
const LenovoContent = () => {
    ...
    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Ноутбуки {'>'} Lenovo</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт ноутбуков Lenovo</div>
                <img src='http://localhost:3000/productsImg/laptops/lenovo.jpg' alt=''/>
            </div>
