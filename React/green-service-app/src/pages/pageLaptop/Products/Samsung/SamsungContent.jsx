...
const SamsungContent = () => {
    ...
    return (
        <div className={cl.ProductsContent}>
            <div>Ремонт в минске {'>'} Ноутбуки {'>'} Samsung</div>
            <div className={cl.TitleWrapper}>
                <div className={cl.Title}>Ремонт ноутбуков Samsung</div>
                <img src='http://localhost:3000/productsImg/laptops/samsung.jpg' alt=''/>
            </div>
