...
function sayHi() { //дефолтный экспорт
    console.log('Hello');
}
...
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.js */ "./src/js/main.js");
 //as first - переименование
// По факту импортируется объект
//экспорт дефолтный, поэтому в {}
...
(0,_main_js__WEBPACK_IMPORTED_MODULE_0__["default"])();//по дефолтным вызов делается также без обёртки
